...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2025 at 09:12 PM
...
CREATE TABLE `productos` (
  ...
  `descripcion_producto` varchar(900) NOT NULL,
...
(10, 'iPad Air 11’', 'El nuevo iPad Air de 11 pulgadas con chip M2 ofrece potencia y versatilidad en un diseño ultrafino y liviano. Con una espectacular pantalla Liquid Retina, cámara frontal ultra gran angular en orientación horizontal, compatibilidad con Apple Pencil Pro y Magic Keyboard, y conectividad Wi‑Fi 6E, es perfecto para estudiar, trabajar, crear y mucho más, estés donde estés.', 707110, 'ipadAir-1.jpg', 10),
(11, 'iPad Pro 13’', 'El iPad Pro de 13 pulgadas con chip M4 redefine lo que es posible en un iPad. Con una increíble pantalla Ultra Retina XDR, potencia de nivel profesional, un diseño ultrafino de titanio y compatibilidad con el Apple Pencil Pro y el nuevo Magic Keyboard, es la herramienta definitiva para los creadores más exigentes. Ligero, potente y espectacular en todo sentido.', 1179304, 'ipadPro13-1.png', 11),
(12, 'iPad mini', 'El iPad mini combina potencia y portabilidad en un diseño compacto de 8,3 pulgadas. Con el chip A15 Bionic, compatibilidad con Apple Pencil (2.ª generación), conectividad USB‑C y 5G en modelos celulares, es perfecto para tomar notas, leer, dibujar o trabajar desde cualquier lugar. Pequeño, pero increíblemente poderoso.', 589062, 'ipadmini-1.png', 12),
(13, 'Airpods 4', 'Los nuevos AirPods 4 redefinen el confort y la experiencia de audio. Con diseño tipo AirPods sin puntas, chip H2, Bluetooth 5.3 y caja USB‑C compacta, ofrecen hasta 5 h de escucha (4 h con ANC) y 30 h totales. Disponibles en versión estándar o con Active Noise Cancellation (ANC), ésta última suma carga inalámbrica, ANC avanzado, Modo Transparencia y audio espacial personalizado con seguimiento dinámico de cabeza. Además, tienen certificación IP54 y control por toque, integrándose a la perfección con el ecosistema Apple.', 152282, 'airpods4-1.jpg', 13),
(14, 'Airpods Pro 2', 'Los AirPods Pro (2.ª generación) ofrecen una experiencia sonora envolvente con cancelación activa de ruido avanzada, modo Ambiente adaptable y audio espacial personalizado. Gracias al chip H2, brindan un sonido de alta fidelidad, mayor autonomía y un rendimiento más inteligente. Incluyen controles táctiles, resistencia al agua y al sudor, y una caja de carga MagSafe con altavoz integrado y conector USB‑C. Todo lo que te gusta de los AirPods, llevado al nivel Pro.', 293940, 'airpodsPro2.jpg', 14),
(15, 'Airpods Max', 'Los AirPods Max combinan un diseño premium con un sonido de calidad extraordinaria. Con drivers personalizados, cancelación activa de ruido avanzada y modo Transparencia, ofrecen una experiencia auditiva inmersiva y detallada. Su estructura de aluminio anodizado y almohadillas de espuma viscoelástica garantizan comodidad para largas sesiones. Equipados con el chip H1 en cada auricular, proporcionan conexión ultraestable, audio espacial y una integración perfecta con todo el ecosistema Apple.', 648086, 'airpodsMax-1.jpg', 15),
(16, 'HomePod', 'El HomePod ofrece un sonido potente y envolvente en un diseño elegante que se adapta a cualquier espacio. Con tecnología de audio avanzada, reconoce la acústica de la habitación para optimizar la reproducción, integra Siri para controlar tu hogar inteligente y gestionar tu música con solo tu voz. Es el altavoz inteligente ideal para quienes buscan calidad sonora y conectividad profunda con el ecosistema Apple.', 205833, 'homepod-1.jpg', 16),
(17, 'HomePod mini', 'El HomePod mini es el altavoz inteligente compacto que sorprende con un sonido claro y lleno de detalle. Su diseño pequeño y colorido se adapta a cualquier lugar, mientras que Siri está siempre listo para ayudarte a reproducir música, controlar dispositivos inteligentes y responder tus preguntas. Con compatibilidad total con el ecosistema Apple, es la manera más sencilla de llenar tu hogar de sonido y comodidad.', 292890, 'homepod-mini-1.jpg', 17);
