<div class="container-alumnas container-fluid d-flex flex-wrap justify-content-center gap-5 p-4">
    <div class="card border-0 shadow-sm text-center" style="width: 350px;">
        <img src="assets/imagenes/alumnas/martu-a.png" alt="Martina Álvarez" class="rounded-circle mx-auto mt-4">
        <div class="card-body">
            <h5 class="card-title">Martina Álvarez</h5>
            <p class="card-text">21/12/2005</p>
            <p class="text-muted">martina.alvarez@davinci.edu.ar</p>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm text-center" style="width: 350px;">
        ...
        <div class="card-body">
            ...
            <p class="text-muted">abril.barrientos@davinci.edu.ar</p>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm text-center" style="width: 350px;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">15/03/2006</p>
            <p class="text-muted">martina.giacomini@davinci.edu.ar</p>
        </div>
    </div>
</div>