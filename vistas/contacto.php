<div class="container-contacto container-fluid">
        <img src="assets/imagenes/contacto/contacto-banner.png" class="banner-desktop mt-3 mb-5 img-fluid rounded-5 w-100" alt="banner contacto apple">
        <img src="assets/imagenes/contacto/contacto-banner-responsive.png" class="banner-tablet mt-3 mb-5 img-fluid rounded-5 w-100 d-none" alt="banner contacto tablet apple">
    <h1 class="text-center mt-5">Asistencia al Cliente</h1>
    <p class="text-center mt-4">Nuestro equipo de expertos en tecnología Apple está a su servicio para asistirlo con cualquier duda, problema o consulta que tenga.</p>
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 mb-4 mb-lg-0 text-center">
                <img class="img-fluid rounded-5 w-100" src="assets/imagenes/contacto/contacto-especialista.jpg" alt="especialista apple">
            </div>
            ...
            <div class="col-12 col-lg-6">
                <form action="?sec='contacto'" method="get">
                    ...
                    <input type="submit" value="Consultar" class="btn btn-primary mb-3 py-2 px-4">
                </form>
            </div>
        </div>
    </div>
    ...
    <section class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 text-center">
                <img class="img-fluid rounded-5 w-100" src="assets/imagenes/contacto/contacto-cursos.jpg" alt="cursos apple">
            </div>
        </div>
    </section>
    ...
    <section class="container py-5">
        <div class="row align-items-center flex-column-reverse flex-lg-row">
            <div class="col-12 col-lg-6 text-center">
                <img class="img-fluid rounded-5 w-100" src="assets/imagenes/contacto/contacto-charlas.jpg" alt="charlas apple">
            </div>
            <div class="col-12 col-lg-6 mb-4 mb-lg-0">
